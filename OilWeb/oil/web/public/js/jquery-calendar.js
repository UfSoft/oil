...
var popUpCal = {
    ...
    displayInline: function(target) {
        ...
        if ( popUpCal.selectedDay == 0 ) popUpCal.selectedDay = new Date().getDate();
        if ( popUpCal.selectedMonth == 0 ) popUpCal.selectedMonth = new Date().getMonth();
        if ( popUpCal.selectedYear == 0 ) popUpCal.selectedYear = new Date().getFullYear();
        popUpCal.adjustDate();
        popUpCal.showCalendar();
    },
