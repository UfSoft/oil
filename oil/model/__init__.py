...
##    sqla.Column('signup', UTCDateTime(timezone=True), nullable=False),
##    sqla.Column('lastlogin', UTCDateTime(timezone=True), nullable=False),
...
##    sqla.Column('date_format', sqla.Unicode),
##    sqla.Column('time_format', sqla.Unicode)
##
##)
##
...
##    sqla.Column('added', UTCDateTime(timezone=True), nullable=False, unique=False),
##    sqla.Column('modified', UTCDateTime(timezone=True), nullable=False, unique=False),
##)
...
#        print repr(self.added)
#        print repr(self.modified)
#
#        if name is None:
...
#    sqla.Column('id', sqla.Integer, primary_key=True, autoincrement=True),
#    sqla.Column('channel_id', sqla.Integer, sqla.ForeignKey('channels.id')),
#    sqla.Column('stamp', UTCDateTime(timezone=True), nullable=False, unique=False),
